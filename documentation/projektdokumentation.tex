...
\nsecbegin{Produktvision-Recherche - Zuarbeiten der Teammitglieder}
\input{ProduktvisionRecherche/Kernfunktionalitaet}%Autor: Patrick Otte
\input{ProduktvisionRecherche/Anwenderprofil}%Autor: Jan Sollmann
\input{ProduktvisionRecherche/PlantUML-Vorstellung}%Autor: Marian Geißler
\input{ProduktvisionRecherche/Konkurrenzprodukte}%Autor: Julian Uebe
\input{ProduktvisionRecherche/MoeglicheWeiterentwicklung}%Autor: Arndt Tore
\input{ProduktvisionRecherche/GUI-Anforderungen}%Autor: Michael Lux
\input{ProduktvisionRecherche/Datenmodell}%Autor: Elisabeth Schuster
\input{ProduktvisionRecherche/ErsteUser-Story}%Autor: Jona Meyer
\input{ProduktvisionRecherche/Workshop-Bedarfsermittlung}%Autor: Johann Gerhardt
\input{ProduktvisionRecherche/Workshop-Recherche}%Autor: Leo Rauschke
\nsecend
...
\nsecbegin{Technolgie-Recherche - Zuarbeiten der Teammitglieder}
\input{TechRecherche/Kommandozeile}%Autor: Marian Geißler
\input{TechRecherche/GUI}%Autor: Patrick Otte
\input{TechRecherche/GUI-Tools}%Autor: Julian Uebe
\input{TechRecherche/JUnit}%Autor: Leo Rauschke
\input{TechRecherche/RegEx}%Autor: Elisabeth Schuster
\input{TechRecherche/XML}%Autor: Jona Meyer
\input{TechRecherche/Xpath}%Autor: Michael Lux
\input{TechRecherche/Softwareverbreitung_Windows}%Autor: Jan Sollmann
\input{TechRecherche/Softwareverbreitung_Linux}%Autor: Tore Arndt
\input{TechRecherche/Exceptions}%Autor: Johann Gerhardt
\nsecend
...
\nsecbegin{Sprint 1 (Autor: Patrick Otte, Tore Arndt)}
\input{sprints/sprint1}
\nsecend

\nsecbegin{Sprint 2 (Autor: Jan Sollmann, Julian Uebe)}
\input{sprints/sprint2}
\nsecend

\nsecbegin{Sprint 3 (Autor: Leo Rauschke)}
\input{sprints/sprint3}
\nsecend

\nsecbegin{Sprint 4 (Autor: Elisabeth Schuster)}
\input{sprints/sprint4}
\nsecend

\nsecbegin{Sprint 5 (Autor: Michael Lux)}
\input{sprints/sprint5}
\nsecend

\nsecbegin{Sprint 6 (Autor: Johann Gerhardt)}
\input{sprints/sprint6}
\nsecend

\nsecbegin{Sprint 7 (Autor: Marian Geißler)}
\input{sprints/sprint7}
\nsecend

\nsecbegin{Sprint 8 (Autor: Jona Meyer)}
\input{sprints/sprint8}
\nsecend
